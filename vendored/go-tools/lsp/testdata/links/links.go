...
import (
	...
	"github.com/prometheus-community/promql-langserver/vendored/go-tools/lsp/foo" //@link(`golang.org/x/tools/internal/lsp/foo`,`https://pkg.go.dev/golang.org/x/tools/internal/lsp/foo`)
