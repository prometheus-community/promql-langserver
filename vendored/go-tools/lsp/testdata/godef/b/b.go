...
import (
	myFoo "github.com/slrtbtfs/promql-lsp/vendored/go-tools/lsp/foo" //@mark(myFoo, "myFoo"),godef("foo", PackageFoo),godef("myFoo", myFoo)
	"github.com/slrtbtfs/promql-lsp/vendored/go-tools/lsp/godef/a"   //@mark(AImport, "\"")
)
