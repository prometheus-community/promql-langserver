...
import (
	...
	"github.com/prometheus-community/promql-langserver/internal/vendored/go-tools/lsp/types" //@item(types_import, "types", "\"golang.org/x/tools/internal/lsp/types\"", "package"),prepare("types","\"", "types")
)
